...
"#
    ...
    pub fn write_call(&mut self, callee: &str, n_args: i16) -> io::Result<()> {
        let caller = self
            .current_function
            .as_deref()
            .unwrap_or("BOOT")
...
"#
    ...
    pub fn write_function(&mut self, f_name: &str, n_locals: i16) -> io::Result<()> {
    ...
    pub fn generate_return_label(&mut self, f_name: &str) -> String {
